...
namespace FMSolution.FMETP
{
    public class DemoScreenshot : MonoBehaviour
    {
        ...
        private void Reset() { MatPano = new Material(Shader.Find("Hidden/FMCubemapToEquirect")); }
        ...
        private IEnumerator SaveJPG(string rootPath)
        {
        ...
        private IEnumerator SaveScreenshotPano()
        {
            yield return new WaitForEndOfFrame();
