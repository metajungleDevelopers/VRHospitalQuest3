...
namespace Chiligames.MetaAvatarsPun
{
    public class NetworkManager : MonoBehaviourPunCallbacks
    {
        ...
        [SerializeField] private string nombreSalaPhoton;
        ...
        public void ConnectToRoom()
        {
            ...
            if (string.IsNullOrEmpty(nombreSalaPhoton))
            {
                nombreSalaPhoton = SceneManager.GetActiveScene().name.ToString();
            }

            PhotonNetwork.JoinOrCreateRoom(nombreSalaPhoton, roomOptions, TypedLobby.Default);
